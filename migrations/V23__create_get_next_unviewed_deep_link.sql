-- V23: Create get_next_unviewed_deep_link function
-- This function was in V19 but may not have been applied properly
-- Returns next unviewed campaign deep link for user rotation
