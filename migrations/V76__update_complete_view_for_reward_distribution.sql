-- V76: Update complete_deep_link_view_session to use reward distribution configuration
-- Split campaign rewards into user rewards, cashback, and Kshipra commission
