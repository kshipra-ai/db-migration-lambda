-- V51: Add review_status filter to campaign rotation function
-- Only show approved campaigns to users
...
'Returns next unviewed APPROVED campaign for user. Only shows campaigns with review_status = approved. If all campaigns viewed, rotates to next campaign after most recently viewed (circular rotation).';
