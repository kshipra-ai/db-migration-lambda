-- V124: Fix complete_deep_link_view_session - Restore V82 working logic + V117 qr_scans feature
-- V82 had correct columns, V117 added qr_scans UPDATE which we need to keep
-- Fixes: removed updated_at, use earned_at, correct kshipra_earnings columns, add qr_scans updates
