-- V127: Fix complete_deep_link_view_session to handle NULL min_view_duration_seconds
-- When a campaign has no min_view_duration_seconds set in DB (NULL), COALESCE to 10s default
-- Without this fix, SQL comparison `actual_duration >= NULL` returns NULL (not TRUE), blocking all rewards
...
BEGIN
    ...
    -- V127 FIX: Default NULL min_view_duration_seconds to 10 seconds
    -- Without this, NULL comparison always returns NULL (not TRUE), blocking all rewards
