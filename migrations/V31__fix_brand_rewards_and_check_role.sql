-- V31: Fix complete_deep_link_view_session to NOT award points to brand users
-- Brand users should NOT earn rewards for scanning QR codes - only regular users should
...
'Completes view session, awards rewards if duration requirement met (first time only) ONLY TO REGULAR USERS (not brands), returns completion status and points awarded';
