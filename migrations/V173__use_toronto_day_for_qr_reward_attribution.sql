-- V173: Use Toronto local day for QR reward attribution.
-- Keeps the V168 per-business share logic but matches scans and completions
-- by America/Toronto date instead of database CURRENT_DATE.
...
'V173: Applies per-business QR host share override and matches scan attribution using America/Toronto local date.';
